...
const afterHtml = content.substring(endIndex + targetEnd.length);
...
const newContent = beforeHtml + newHtmlTemplate + afterHtml;
fs.writeFileSync(file, newContent);
console.log("Rebuilt layout and injected ApexCharts successfully.");

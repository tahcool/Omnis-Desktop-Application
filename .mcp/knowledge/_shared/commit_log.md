...
\n## 2026-08-04
- `91404c4` 2026-08-04 [supabase-migration] feat: Integrate Sinopower division, data segmentation, and UI filters
...
- `84509c6` 2026-08-06 [supabase-migration] fix: use rowspan for DBR customer grouping instead of accordion style
  Files: systems/fleetrack/index.html,
- `8bd25c6` 2026-08-06 [supabase-migration] fix: print DBR table ordering, conditionally show machine data, and implement customer rowspan grouping in print view
  Files: .mcp/knowledge/_shared/commit_log.md,.mcp/knowledge/fleetrack/session_notes.md,systems/fleetrack/index.html,
...
\n## 2026-08-17
- `c62eb52` 2026-08-17 [supabase-migration] Restore point before salestrack contacts fix
...
- `96fb2d5` 2026-08-18 [supabase-migration] Restore point: before updating Order Tracking print report
  Files: .mcp/knowledge/_shared/commit_log.md,systems/salestrack/index.html,
- `cb11404` 2026-08-18 [supabase-migration] [checkpoint] Checkpoint before further changes
...
- `6268246` 2026-08-19 [supabase-migration] UI: Refine Salestrack dashboard profile header, navbar and performance cards
  Files: .mcp/knowledge/_shared/commit_log.md,systems/salestrack/dashboard_logic.js,systems/salestrack/index.html,
...
- `3274f9f` 2026-09-08 [supabase-migration] [checkpoint] Fix quotation pagination overflow and migrate all missing quotations and line items
...
\n## 2026-09-14
- `a8963ca` 2026-09-14 [feature/admin-service-key-separation] fix: reparent view-settings from view-dashboard to document.body
  Files: .env,.mcp/knowledge/_shared/commit_log.md,supabase/.branches/_current_branch,supabase/functions/admin-operations/index.ts,supabase/functions_original/_shared/admin-config.ts,supabase/functions_original/admin-operations/index.ts,supabase/functions_original/ai-marketing-assistant/.npmrc,supabase/functions_original/ai-marketing-assistant/deno.json,supabase/functions_original/ai-marketing-assistant/index.ts,supabase/functions_original/ai-proxy/index.ts,supabase/functions_original/daily-quote-reminders/index.ts,supabase/functions_original/email-submit/index.ts,supabase/functions_original/migrate-frappe-user/.npmrc,supabase/functions_original/migrate-frappe-user/deno.json,supabase/functions_original/migrate-frappe-user/index.ts,supabase/functions_original/notify-new-record/.npmrc,supabase/functions_original/notify-new-record/deno.json,supabase/functions_original/notify-new-record/index.ts,supabase/functions_original/omnis-link/.npmrc,supabase/functions_original/omnis-link/deno.json,
- `cfd0a6a` 2026-09-14 [feature/admin-service-key-separation] [checkpoint] fix: customer form save, sales delete via Supabase, themed toast notifications
  Files: .mcp/knowledge/_shared/commit_log.md,systems/salestrack/dashboard_logic.js,systems/salestrack/index.html,
- `07e0214` 2026-09-14 [feature/admin-service-key-separation] [checkpoint] fix(tablet): invalid API key and PSV submission auth — v1.1.0
  Files: .mcp/knowledge/_shared/commit_log.md,omnis-tablet/app.json,omnis-tablet/src/screens/LogActivityScreen.tsx,omnis-tablet/src/screens/VisitHistoryScreen.tsx,
\n## 2026-09-15
...
- `aae8433` 2026-09-16 [feature/admin-service-key-separation] checkpoint: PDF enhancement - real logos, product catalog enrichment, dynamic branding, IPC proxy
...
- `61138cd` 2026-09-16 [feature/admin-service-key-separation] chore: bump version to 4.5.0
  Files: .mcp/knowledge/_shared/commit_log.md,RELEASE_NOTES.md,package.json,systems/fleetrack/index.html,systems/powertrack/dashboard.html,systems/powertrack/powertrack_index.html,systems/salestrack/dashboard_logic.js,systems/salestrack/index.html,version.json,
\n## 2026-09-17
...
- `4f73bba` 2026-09-17 [feature/admin-service-key-separation] fix: viewport-aware positioning for item search dropdown (wireQtnItemSearch) — flips upward near screen bottom
  Files: .mcp/knowledge/_shared/commit_log.md,systems/salestrack/index.html,
- `c6ec725` 2026-09-17 [feature/admin-service-key-separation] fix: force item search dropdown to always open upward above the input field
  Files: .mcp/knowledge/_shared/commit_log.md,systems/salestrack/index.html,

...
const styles = {
    'Create Service Booking': {
        ...
        hover: "linear-gradient(135deg, #60a5fa, #2563eb)"
    },
    'Log Defect': {
        ...
        hover: "linear-gradient(135deg, #f87171, #dc2626)"
    },
    'Log Tech Hours': {
        ...
        hover: "linear-gradient(135deg, #2dd4bf, #0d9488)"
    },
    'Export Report': {
        ...
        hover: "linear-gradient(135deg, #a78bfa, #7c3aed)"
    },
    'Bulk HMR Entry': {
        ...
        hover: "linear-gradient(135deg, #94a3b8, #475569)"
    },
    'Lookup': {
        normal: "display:flex;align-items:center;justify-content:center;gap:8px;padding:10px 20px;background:linear-gradient(135deg, #64748b, #334155);color:#ffffff;border:1px solid #1e293b;border-radius:10px;font-size:13px;font-weight:700;cursor:pointer;box-shadow:0 4px 10px rgba(51, 65, 85, 0.25);transition:all .2s ease;white-space:nowrap;text-shadow:0 1px 2px rgba(0,0,0,0.1);",
        hover: "linear-gradient(135deg, #94a3b8, #475569)"
    ...
    'Add Machine': {
        ...
        hover: "linear-gradient(135deg, #4ade80, #16a34a)"
    }
};
...
$('button').each((i, el) => {
    ...
    if (styles[text]) {
        ...
        let normalBg = styleObj.normal.match(/background:(.*?);/)[1];
        
        $(el).attr('onmouseover', `this.style.background='${styleObj.hover}';this.style.transform='translateY(-1px)';this.style.boxShadow='0 6px 14px ' + '${styleObj.normal.match(/rgba\\(.*?\\)/)[0]}'.replace('0.25', '0.4');`);
        $(el).attr('onmouseout', `this.style.background='${normalBg}';this.style.transform='translateY(0)';this.style.boxShadow='${styleObj.normal.match(/box-shadow:(.*?);/)[1]}';`);
        count++;
    }
});

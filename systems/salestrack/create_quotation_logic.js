...
(function () {
    ...
    window.addQuotationItemRow = function () {
        ...
        console.log('[QtnItemRow] Row added. setupSupabaseSuggestions available:', !!window.setupSupabaseSuggestions);
        
        // Search wiring is handled by the override in index.html
    };
